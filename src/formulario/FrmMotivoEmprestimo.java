 ...
 */
public class FrmMotivoEmprestimo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cadastro de Motivo do Empréstimo");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (this.txtCodigo.getText().equals("")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                motivoEmprestimoDao.delete(Integer.parseInt(txtCodigo.getText()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        motivo.setMotivoEmprestimo(txtTexto.getText().toUpperCase());
        // CADATRAO NOVO NO BANCO //////////////////////////////////////////
        if (novo) {

            motivoEmprestimoDao.insert(motivo);
            ...
            motivo.setIdMotivoEmprestimo(Integer.parseInt(txtCodigo.getText()));
            motivoEmprestimoDao.update(motivo);
            JOptionPane.showMessageDialog(this, "Alterado com Sucesso !!!", null, JOptionPane.ERROR_MESSAGE);
            //log do sistema
            logDao.insert("Alterado cargo: " + motivoAntigo + " para -> " + txtTexto.getText().trim());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMotivoEmprestimo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMotivoEmprestimo().setVisible(true);
            }
        });
    }
    ...
    public void carregaGrelha() {
        ...
        for (MotivoEmprestimo motivo : lista) {
            ...
            modelo.addRow(new Object[]{
                motivo.getIdMotivoEmprestimo(),
                motivo.getMotivoEmprestimo(),});
        }
    }
