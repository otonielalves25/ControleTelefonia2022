 ...
 * @author Tony
 */
public class FrmLocalidadeConsultaRapida extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public FrmLocalidadeConsultaRapida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void carregaPesquisa() {
        List<Localidade> listagem = localidadeDao.getListagemLike(txtPesquisa.getText());
        modeloTabela.setNumRows(0);
        for (Localidade local : listagem) {
            modeloTabela.addRow(new Object[]{
                local.getIdLocalidade(),
                local.getNomeLocalidade(),
                local.getTipoLocalidade()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nome da localidade:");
    ...
    private void grelhaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grelhaMouseClicked
        ...
        if (evt.getClickCount() >= 1) {
            ...
            this.setLocalidade(localidadeDao.retornaPorID(codigo));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLocalidadeConsultaRapida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmLocalidadeConsultaRapida dialog = new FrmLocalidadeConsultaRapida(new javax.swing.JFrame(), true);
